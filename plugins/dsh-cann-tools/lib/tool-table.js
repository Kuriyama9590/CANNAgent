...
export const ANY_OBJECT = { type: 'object', additionalProperties: true };
const runId = { type: 'string', required: true, description: 'run id（run 目录名）' };
...
//# sourceMappingURL=tool-table.js.map